                ...
                <div class="ibox-content">
                    <form id="AcademyForm" name="AcademyForm" class="form-horizontal" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" id="eduLevel" class="form-control required" name="eduLevel"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" id="sort" class="form-control required" name="sort"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="state" id="state" style="width:140px;">
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            if (eduLevel != null && eduLevel != '') {
                $.ajax({
                    type: "POST",
                    url: '<%=basePath%>api/course/specialty_type_add?tm=' + new Date().getTime(),
                    data: {
                        "eduLevel": eduLevel,
                        "code": code,
                        "sort": sort,
