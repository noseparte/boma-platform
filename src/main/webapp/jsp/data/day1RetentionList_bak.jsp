...
<html lang="zh-CN">
	...
	<body>
		<c:set var="preUrl" value="day1RetentionList
									?startTime=${ startTime }
									&channelid=${ channelid }
		...
		<header class="ui-page-header">
			<div class="mini-title">当前位置：留存玩家统计</div>
		</header>
		<article class="container-fluid">
			...
			<table class="table table-hover table-bordered table-condensed">
				...
				<tbody id="topic-list">
					<c:forEach var="registerAnalysis" items="${ day1RetentionList }">
					<tr data-id="${ registerAnalysis.datetime }">
						...
						<td>${ registerAnalysis.day1retention }</td>
						<td>${ registerAnalysis.day1retentionrate }%</td>
					</tr>
					</c:forEach>
				</tbody>
			</table>
