...
<!-- <script type="text/javascript" src="<%=basePath%>js/1.js"></script> -->
<script type="text/javascript">
	...
	(function() {
		...
		MX.load = function(a) {
			var c = a.js,
				b = c ? ".js" : ".css",
				d = -1 == location.search.indexOf("jsDebug"),
				e = a.js || a.css;
			-1 == e.indexOf("http://") ? (e = (a.path || window.basePath) + ((c ? "js/" : "css/") + e) + (!d && !c ? ".source" : ""), b = e + (a.version ? "_" + a.version : "") + b) : b = e;d || (d = b.split("#"), b = d[0], b = b + (-1 != b.indexOf("?") ? "&" : "?") + "r=" + Math.random(), d[1] && (b = b + "#" + d[1]));
			if (c) {
				var c = b,
					h = a.success,
				...
				<div class="col-sm-12">
					<form class="navbar-form navbar-left" role="search">
						...
						<div class="form-group">
							<span class="text-warning glyphicon glyphicon-calendar"
								id="start" style="cursor:pointer;"></span> <input
							...
							~ <span class="text-warning glyphicon glyphicon-calendar"
								id="end" style="cursor:pointer;"></span> <input
						...
						<table
							...
							<thead>
								<tr style="background:#60686b;">
									...
									<th class="min-w50">当日留存率(%)</th>
									<th class="min-w50">次日留存率(%)</th>
									<th class="min-w80">3日留存率(%)</th>
									<th class="min-w80">4日留存率(%)</th>
									<th class="min-w80">5日留存率(%)</th>
									<th class="min-w80">6日留存率(%)</th>
									<th class="min-w80">7日留存率(%)</th>
									<th class="min-w80">30日留存率(%)</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach var="one" items="${ retentionLst }"
									varStatus="status">
									<tr>
										<%-- <td>${status.count }</td> --%>
										<td>${ one.date }</td>
