                ...
                <div class="ibox-content">
                    <div id="toolbar" class="btn-group">
                        <div class="pull-left form-inline form-group">
                            <input type="text" id="third_name" name="third_name" class="form-control"
                                   placeholder="支付名称"/>
...
<script type="text/javascript">
    ...
    //表格请求及数据
    var tableColumns = {
        url: 'api/pay/get_third_pay_list?tm=' + new Date().getTime(),
        toolbar: '#toolbar',
    ...
    //跳转到新增页面
    function toAdd() {
        window.location.href = "<%=basePath%>api/pay/to_third_pay_add";
    }
    ...
    function toEdit() {
        ...
        window.location.href = "<%=basePath%>api/pay/to_third_pay_update?id=" + ids[0];
    }
