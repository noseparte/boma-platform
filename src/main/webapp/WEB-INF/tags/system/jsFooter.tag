...
<script src="js/module/TreeList.js"></script>
<!-- åå§åä¸ææ¡ -->
...
<!-- dateTool js  -->
<script src="js/util/jsDate/dateTool.js"></script>
<!-- bootstrapValidator.min.js -
<script src="hplus/js/plugins/jquery.bootstrapvalidator/0.5.3/js/bootstrapValidator.min.js"></script>
<!-- swfupload -->
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		// bootstrapdatetimepicker validator
		 $(".bootstrapdatetimepicker-validator").datetimepicker({  
		    format: 'yyyy-mm-dd hh:ii:00',
		    timepicker: true,
		    autoclose: true,
		    language: 'zh-CN',
    		...
    		$form.data('bootstrapValidator')//
    				  .updateStatus(nameVal, 'NOT_VALIDATED',null)//
    				  .validateField(nameVal);
        });
	});
