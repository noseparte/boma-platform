...
public class TaskLoginServer implements Runnable {
...
//			new SparkStreamingDataMannuallyProducerForKafka("test-topic").start();//
		...
		private static String Loginlogs() {
			  StringBuffer loginLogBuffer = new StringBuffer("");
			  ...
			  accountid = String.valueOf((long) random.nextInt((int) 20000));
			  String uuid ="";
			  String mac = String.valueOf((long) random.nextInt((int) 2000000));
			  String imei = String.valueOf((long) random.nextInt((int) 2000000));
			  String imeiID = String.valueOf((long) random.nextInt((int) 2000000));
			  ...
			  String logouttime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date());
			   ...
			   loginLogBuffer.append("{\"DateTime\":\"").append(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()))
			      			      .append("\",\"Type\":\"")
			      .append("Login")
			      .append("\",\"Misc1\":\"")
			      .append(ts)
			  ...
			  return loginLogBuffer.toString();
