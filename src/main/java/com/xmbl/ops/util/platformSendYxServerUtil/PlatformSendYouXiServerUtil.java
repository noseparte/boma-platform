package com.xmbl.ops.util.platformSendYxServerUtil;
...
public class PlatformSendYouXiServerUtil {
	 ...
	 * @return
	 */
	public static String getURL(String ip,Integer host,String jsonInfo) {
		try {
			LOGGER.info("平台向游戏服务器发送请求地址,ip,{},host,{},jsonInfo,{}",ip,host,jsonInfo);
			StringBuffer sBuffer = new StringBuffer();
			sBuffer.append("http://");
			sBuffer.append(ip);
			sBuffer.append(":");
			sBuffer.append(host);
			sBuffer.append(jsonInfo);
